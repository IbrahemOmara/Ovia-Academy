...
export default function LiveTradingNs() {

  const dataUser =  JSON.parse(localStorage.dataAuth);
  const navagite = useNavigate();
  const [urlMeetingNow, setUrlMeetingNow] = useState(
    "https://livezoon.com/join?room=6666&roomPassword=false&name=admin&username=admin&audio=true&video=false&screen=false&notify=false&admin=1&&origin=ncomes.network&priamry_color=#223f4a"
  )
