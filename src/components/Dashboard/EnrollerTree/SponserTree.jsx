...
const NetworkTree = () => {
  ...
  const renderTree = (nodeId) => {
    ...
    return (
      <div className="tree-node-s">
        <div className={`node-box-circle-s`} onClick={() => handleNodeClick(node)}>
          <div className="avatar-circle-s">
            <img src={DEFAULT_AVATAR} alt="avatar-s" />
          </div>
          <div className="node-id-s">{node.id}</div>
        </div>
        <div className="node-name-s">{node.name}</div>
        ...
        {isExpanded && node.children.length > 0 && (
          <div className="children-s binary">
            ...
            <div style={{ textAlign: "center", marginTop: "40px" }}>
              <button
                ...
                onClick={() => {
                  ...
                  setResetFlag(true);
                  navigate("/dashboard-user/sponser-tree", { replace: true });
                }}
              >
                Back to Root
              </button>
